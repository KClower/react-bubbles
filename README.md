...
A token is used as an authorization code to the server to allow access to private areas of an application.

- [ ] What steps can you take in your web apps to keep your data secure?

Protect a route, require a sign in.

- [ ] Describe how web servers work.

Web servers take a request from the front end and send back the requested information if accessable
